...
namespace GOV.NASA.GSFC.XR.MRET.UI.Animation
{
    public class AnimationMenuController : MonoBehaviour
    {
        ...
        public void WrapmodeValueChanged()
        {
            ...
            ActivePlayer.WrapMode = (ActionSequenceWrapModeType)Enum.Parse(
                typeof(ActionSequenceWrapModeType), wrapmode.options[wrapmode.value].text);
        }
        ...
        public void DirectionValueChanged()
        {
            ...
            ActivePlayer.Direction = (ActionSequenceDirectionType)Enum.Parse(
                typeof(ActionSequenceDirectionType), direction.options[direction.value].text);
        }
