...
{
    [System.Obsolete("Refer to the " + nameof(GOV.NASA.GSFC.XR.MRET.UI.Data.DataDisplayListPanelController) + " class")]
    public class DataDisplayListPanelControllerDeprecated : MonoBehaviour
    {
        ...
        private InteractablePartDeprecated interactablePart;

        void Start()
        {
            dataManager = FindObjectOfType<DataManager>();
            scrollListManager.SetTitle("Data Points");
            interactablePart = GetComponentInParent<InteractablePartDeprecated>();
            if (interactablePart)
            {
