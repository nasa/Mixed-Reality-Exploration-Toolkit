...
using GOV.NASA.GSFC.XR.MRET.Cameras;
using GOV.NASA.GSFC.XR.MRET.Data;
using GOV.NASA.GSFC.XR.MRET.Integrations.XRUI;

namespace GOV.NASA.GSFC.XR.MRET.UI.Cameras
{
    /// <summary>
    ...
    public class CameraMenuController : MenuController
    {
        ...
        {
            MRET.DataManager.SaveValue(imageCamera0Key, false);
            MRET.DataManager.SaveValue(imageCamera1Key, false);
            MRET.DataManager.SaveValue(videoCamera0Key, false);
            MRET.DataManager.SaveValue(videoCamera1Key, false);
            MRET.DataManager.SaveValue(bodyCameraKey, false);
        ...
        {
            if ((bool) MRET.DataManager.FindPoint(bodyCameraKey) == false)
            {
                EnableBodyCamera();
            }
            else
        ...
        public void DisableAllCameras()
        {
            ...
            // Save to DataManager.
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera0Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera1Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera0Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera1Key, false));
        }
        ...
        public void EnableImageCamera()
        {
            ...
            videoCameraManager.capturingLeft = videoCameraManager.capturingRight = false;
            MRET.ControlMode.EnterCameraMode();
            ...
            // Save to DataManager.
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera0Key, hand.handedness == InputHand.Handedness.left));
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera1Key, hand.handedness == InputHand.Handedness.right));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera0Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera1Key, false));
        }
        ...
        public void EnableVideoCamera()
        {
            ...
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera0Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(imageCamera1Key, false));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera0Key, hand.handedness == InputHand.Handedness.left));
            MRET.DataManager.SaveValue(new DataManager.DataValue(videoCamera1Key, hand.handedness == InputHand.Handedness.right));
        ...
        public void EnableBodyCamera()
        {
            ...
            */
            ...
            // Save to DataManager.
            MRET.DataManager.SaveValue(new DataManager.DataValue(bodyCameraKey, true));
        }
        ...
        public void DisableBodyCamera()
        {
            ...
            // Save to DataManager.
            MRET.DataManager.SaveValue(new DataManager.DataValue(bodyCameraKey, false));
        }
    }
}