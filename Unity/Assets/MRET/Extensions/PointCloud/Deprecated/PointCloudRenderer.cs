...
namespace GOV.NASA.GSFC.XR.MRET.Extensions.PointCloud
{
    public class PointCloudRenderer : MonoBehaviour
    {
        ...
        void ModifyPointVolumePosition()
        {
            ...
            // NoteDeprecated that in modified_pos_W_Matrix the rotation I have defaulted so that I can figure out why points are not showing up directly on the controller
