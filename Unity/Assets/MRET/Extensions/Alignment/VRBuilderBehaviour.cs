...
namespace GOV.NASA.GSFC.XR.MRET.Extensions.EasyBuildSystem.Alignment
{
    ...
    public class VRBuilderBehaviour : MRETUpdateManager<VRBuilderBehaviour>
    {
        /// <seealso cref="MRETBehaviour.ClassName"/>
        public override string ClassName => nameof(VRBuilderBehaviour);
...
#if !MRET_EXTENSION_EASYBUILDSYSTEM
            Debug.LogWarning("Easy Build System is unavailable");
#endif
        }
