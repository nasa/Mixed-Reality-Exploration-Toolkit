            ...
            if (dataManager)
            {
                ...
                if (!terrainMetadataInitialized)
                {
                        ...
                        (terrainCenterLatitudeVar is double))
                    {
                        ...
                        Log("Terrain Hight (m): " + terrainZ.ToString("F3"));
                        ...
                        Log("Terrain Width (m): " + terrainX.ToString("F3"));
                    ...
                    (objectHeadingVar is double))
                {
                    ...
                    // Start with the time
                    string logMessage = "Date/Time: " + time.ToUniversalTime().ToString("u") + "\n";

                    logMessage += "Location [Lon,Lat,El]: " + moonLongitude + ", " + moonLatitude + ", " + moonElevation + "km\n";
                    logMessage += "Location Deg [Lon,Lat]: [" + moonLongitudeDeg.ToString("F3") + ", " + moonLatitudeDeg.ToString("F3") + "]";
                    logMessage += "Location DMS [Lon, Lat]: [" +
                    ...
                    if (sunlightObject != null)
                    {
                            ...
                            (sunLatitudeVar is double))
                        {
                            ...
                            logMessage += "Sun Vector [X,Y,Z]: " + sunPositionVec.x + ", " + sunPositionVec.y + ", " + sunPositionVec.z + ", " + "\n";
                            logMessage += "Sun Distance, Azimuth, Altitude: " +
                                sunRadius + "km, " +
                                sunAzimuthDeg + ", " +
                                sunAltitudeDeg + "\n";

                            logMessage += "Subsolar point: " +
                    ...
                    if (earthObject != null)
                    {
                            ...
                            (earthAltitudeVar is double))
                        {
                            ...
                            logMessage += "Earth Vector [X,Y,Z]: " + earthPositionVec.x + ", " + earthPositionVec.y + ", " + earthPositionVec.z + ", " + "\n";
                            logMessage += "Earth Distance, Azimuth, Altitude: " +
                                earthRadius + "km, " +
                                earthAzimuthDeg + ", " +
                                earthAltitudeDeg + "\n";
