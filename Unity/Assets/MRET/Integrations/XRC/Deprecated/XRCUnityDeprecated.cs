...
{
    [Obsolete("Refer to " + nameof(GOV.NASA.GSFC.XR.MRET.Integrations.XRC.XRCUnity))]
    public class XRCUnityDeprecated : MonoBehaviour
    {
        ...
        public static Queue<EntityEventParametersDeprecated> entityCreatedEventQueue = new Queue<EntityEventParametersDeprecated>();
        public static Queue<EntityEventParametersDeprecated> entityDestroyedEventQueue = new Queue<EntityEventParametersDeprecated>();
        public static Queue<EntityEventParametersDeprecated> entityReinitializedEventQueue = new Queue<EntityEventParametersDeprecated>();
        public static Queue<EntityEventParametersDeprecated> entityUpdatedEventQueue = new Queue<EntityEventParametersDeprecated>();
        public static Queue<EntityEventParametersDeprecated> entityEditedEventQueue = new Queue<EntityEventParametersDeprecated>();
        public static Queue<ActiveSessionEventParametersDeprecated> asParticipantAddedEventQueue = new Queue<ActiveSessionEventParametersDeprecated>();
        public static Queue<ActiveSessionEventParametersDeprecated> asParticipantResyncedEventQueue = new Queue<ActiveSessionEventParametersDeprecated>();
        public static Queue<ActiveSessionEventParametersDeprecated> asParticipantDeletedEventQueue = new Queue<ActiveSessionEventParametersDeprecated>();
        ...
        private static XRCUnityDeprecated xrcUnity;
...
#region Entity callback handlers.
        ...
        (entityId) =>
        {
            ...
            entityCreatedEventQueue.Enqueue(new EntityEventParametersDeprecated(tag, type, resource,
                category, subcategory, bundle, entityId, parUUID,
                new InteractablePartDeprecated.InteractablePartSettings(interaction, collision, gravity),
                title, text,
        ...
        (entityId) =>
        {
            ...
            entityDestroyedEventQueue.Enqueue(new EntityEventParametersDeprecated(
        ...
        (entityId) =>
        {
            ...
            entityReinitializedEventQueue.Enqueue(new EntityEventParametersDeprecated(tag, type, resource,
                category, subcategory, bundle, entityId, parUUID,
                new InteractablePartDeprecated.InteractablePartSettings(interaction, collision, gravity),
                title, text,
                xPos, yPos, zPos, xRot, yRot, zRot, wRot, xScl, yScl, zScl,
        ...
        (entityId) =>
        {
            ...
            entityUpdatedEventQueue.Enqueue(new EntityEventParametersDeprecated(tag, type, resource,
        ...
        (entityId) =>
        {
            ...
            entityEditedEventQueue.Enqueue(new EntityEventParametersDeprecated(tag, type, resource,
                category, subcategory, null, entityId, parUUID,
                new InteractablePartDeprecated.InteractablePartSettings(interaction, collision, gravity),
                title, text,
                xPos, yPos, zPos, xRot, yRot, zRot, wRot, xScl, yScl, zScl,
...
#region Active session callback handlers.
        ...
        (participantId) =>
        {
            ...
            asParticipantAddedEventQueue.Enqueue(new ActiveSessionEventParametersDeprecated(participantId, tag,
        ...
        (participantId) =>
        {
            ...
            asParticipantResyncedEventQueue.Enqueue(new ActiveSessionEventParametersDeprecated(participantId, tag,
                type, color, lc, rc, lp, rp));
        ...
        (participantId) =>
        {
            ...
            asParticipantDeletedEventQueue.Enqueue(new ActiveSessionEventParametersDeprecated(participantId, tag,
                type, color, lc, rc, lp, rp));
...
#region Remote session callback handlers.
        ...
        public static bool AddSessionEntity(string tag, string category, string subcategory,
            ...
            InteractablePartDeprecated.InteractablePartSettings settings, byte[] resource, string title, string text,
        ...
        public static bool AddSessionEntity(string tag, string category, string subcategory,
            string bundle, string objectID, string parentID, InteractablePartDeprecated.InteractablePartSettings settings, byte[] resource,
            ...
            UnitType posUnits = UnitType.unitless, UnitType rotUnits = UnitType.unitless, UnitType sclUnits = UnitType.unitless)
        {
            if (XRCInterface.IsSessionActive)
            {
                ...
                if (settings == null)
                {
                    settings = InteractablePartDeprecated.InteractablePartSettings.defaultSettings;
                }
        ...
        public static SessionEntityDeprecated GetSessionEntity(string entityId)
        {
            if (XRCInterface.IsSessionActive)
            {
                ...
                return new SessionEntityDeprecated(tag, EntityEventParametersDeprecated.EntityTypeFromXRCEntityType(eType),
        ...
        public static SessionEntityDeprecated[] GetAllSessionEntities()
        {
            if (XRCInterface.IsSessionActive)
            {
                XRCInterface.StagedEntitiesClear();
                XRCInterface.GetSessionEntities();
                List<SessionEntityDeprecated> sessionEntities = new List<SessionEntityDeprecated>();
                string[] entityIds;
                XRCInterface.GetStagedEntityIds(out entityIds);
                foreach (string entityId in entityIds)
                {
                    SessionEntityDeprecated sessionEntity = GetSessionEntity(entityId);
        ...
        public static bool UpdateEntitySettings(string id, InteractablePartDeprecated.InteractablePartSettings settings)
        {
            if (XRCInterface.IsSessionActive)
            {
                if (!XRCInterface.GetSessionEntity(id)) return false;
