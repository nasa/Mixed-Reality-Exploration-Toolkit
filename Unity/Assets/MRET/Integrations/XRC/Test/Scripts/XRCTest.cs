...
public class XRCTest : MonoBehaviour
{
    ...
    public SynchronizedUserDeprecated.UserType userType = SynchronizedUserDeprecated.UserType.VR;
    public SynchronizedUserDeprecated.LabelColor userLabelColor = SynchronizedUserDeprecated.LabelColor.black;
    ...
    public void SessionJoiningEventManager()
    {
        ...
        foreach (SessionEntityDeprecated userEntity in xrcManager.GetSessionUsers())
        {
    ...
    private void RunMasterTest()
    {
        ...
        Debug.Log("[XRCTest] Initializing XRC" +
            ...
            "; group=" + groupName +
            "; session=" + sessionName);
        XRCUnityDeprecated.Initialize(serverHost, serverPort, connectionType,
        ...
        XRCUnityDeprecated.StartSession(userUUID.ToString(), userAlias, (int) userType,
        ...
        XRCManagerDeprecated.AddControllersToSession(userAlias, userUUID.ToString(),
        ...
        foreach (string arg in args)
        {
            ...
            if (t != -1)
            {
                ...
                if (key.Length > 0 && value.Length > 0)
                {
                    ...
                    {
                        userLabelColor = (SynchronizedUserDeprecated.LabelColor)Enum.Parse(typeof(SynchronizedUserDeprecated.LabelColor), value, true);
    ...
    private void Update()
    {
        ...
        else if (updateSessionsList)
        {
            ...
            // Add new buttons.
            int idx = 0;
            availableXRCSessions = XRCUnityDeprecated.GetRemoteSessions();
            foreach (IRemoteSession sessionInfo in availableXRCSessions)
            {
    ...
    private void JoinSession(int idx)
    {
        ...
        XRCUnityDeprecated.JoinSession(availableXRCSessions[idx].id,
