...
namespace GOV.NASA.GSFC.XR.MRET.Animation
{
    ...
    /// group is a container for animations (subclasses of MRETBaseAnimationDeprecated). The default implementation
    ...
    /// </summary>
    public class MRETAnimationGroupDeprecated : MRETBaseAnimationDeprecated
    {
        // Types
        ...
        private List<MRETBaseAnimationDeprecated> sequence = new List<MRETBaseAnimationDeprecated>();
        ...
        public void AddAnimation(MRETBaseAnimationDeprecated animation)
        {
        ...
        /// <returns></returns>
        public MRETBaseAnimationDeprecated AnimationAt(int index)
        {
            MRETBaseAnimationDeprecated result = null;
        ...
        public MRETBaseAnimationDeprecated CurrentAnimation()
        {
        ...
        public void Clear()
        {
            foreach (MRETBaseAnimationDeprecated animation in sequence)
            {
        ...
        /// <param name="animation"></param>
        /// <returns></returns>
        public int IndexOfAnimation(MRETBaseAnimationDeprecated animation)
        {
        ...
        /// <param name="index"></param>
        /// <param name="animation"></param>
        public void InsertAnimation(int index, MRETBaseAnimationDeprecated animation)
        {
        ...
        /// </summary>
        /// <param name="animation"></param>
        public void RemoveAnimation(MRETBaseAnimationDeprecated animation)
        {
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public MRETBaseAnimationDeprecated RemoveAnimationAt(int index)
        {
            MRETBaseAnimationDeprecated animation = sequence[index];
        ...
        private void ApplyTime(float loopTime)
        {
            ...
            MRETBaseAnimationDeprecated animation = AnimationAt(targetIndex);
        ...
        public static void DeserializeTo(AnimationGroupType serializedAnimation, MRETAnimationGroupDeprecated group)
        {
            Debug.Log("[MRETAnimationGroup->DeserializeTo] ");
            MRETBaseAnimationDeprecated.DeserializeTo(serializedAnimation, group);
            ...
            {
                MRETBaseAnimationDeprecated animation = null;

                // Check the type and create the correct type of animation
                if (animationType.GetType() == typeof(AnimationGroupType))
                {
                    animation = MRETAnimationGroupDeprecated.Deserialize((AnimationGroupType)animationType);
                }
                else if (animationType.GetType() == typeof(AnimationActionType))
                {
                    animation = MRETActionAnimationDeprecated.Deserialize((AnimationActionType)animationType);
                }
                else if (animationType.GetType() == typeof(AnimationPropertyType))
                {
                    animation = MRETPropertyAnimationDeprecated.Deserialize((AnimationPropertyType)animationType);
                }
        ...
        public static MRETAnimationGroupDeprecated Deserialize(AnimationGroupType serializedAnimation)
        {
            Debug.Log("[MRETAnimationGroup->Deserialize] ");
            MRETAnimationGroupDeprecated deserialized = new MRETAnimationGroupDeprecated();
