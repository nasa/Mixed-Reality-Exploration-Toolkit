...
namespace GOV.NASA.GSFC.XR.MRET.Animation
{
	...
	/// </summary>
	/// 
    public class MRETAnimationPlayer : Identifiable<IdentifiableType>
    {
        // Event publishing
        ...
        // Properties
        private IActionSequence baseAnimation;
       ...
       /// <summary>
        ...
        /// </summary>
        public IActionSequence MRETAnimation
        {
            get => baseAnimation;
            set
            {
        ...
        public override string ClassName => nameof(MRETAnimationPlayer);
        ...
        {
            Log("Event triggered", nameof(OnValidate));
                    ...
                    switch (baseAnimation.WrapMode)
                    {
                        case ActionSequenceWrapModeType.Once:
                            if (baseAnimation.CurrentTime <= 0 &&
                                Direction == ActionSequenceDirectionType.Forward)
                            {
                                State = State.Stopped;
                                ...
                                Direction == ActionSequenceDirectionType.Backward)
                            {
                                State = State.Stopped;
        ...
        {  
            if (oldState == State.Stopped)
            {
                ...
                {
                    case State.Running:
                        if (Direction == ActionSequenceDirectionType.Forward)
                        {
