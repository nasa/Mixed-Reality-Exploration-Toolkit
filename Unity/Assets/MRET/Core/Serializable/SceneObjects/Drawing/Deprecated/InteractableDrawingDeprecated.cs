...
{
    [System.Obsolete("Refer to " + nameof(GOV.NASA.GSFC.XR.MRET.SceneObjects.Drawing.IInteractableDrawing))]
    public class InteractableDrawingDeprecated : InteractableSceneObjectDeprecated
    {
        ...
        public Material highlightMaterial; // TODO: get from MRET.

        public new static InteractableDrawingDeprecated Create()
        {
            GameObject interactableDrawingGameObject = new GameObject();
            return interactableDrawingGameObject.AddComponent<InteractableDrawingDeprecated>();
        }
