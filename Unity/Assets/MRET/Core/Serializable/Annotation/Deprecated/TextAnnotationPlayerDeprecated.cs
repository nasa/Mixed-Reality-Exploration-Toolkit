...
{
    [System.Obsolete("Refer to the " + nameof(GOV.NASA.GSFC.XR.MRET.Annotation.TextAnnotationPlayer) + " class")]
    public class TextAnnotationPlayerDeprecated : MonoBehaviour
    {
