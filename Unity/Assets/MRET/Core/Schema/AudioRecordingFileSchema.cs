...
namespace GOV.NASA.GSFC.XR.MRET.Schema
{
    ...
    ///
    /// <summary>
    /// AudioRecordingFileSchema
    /// 
    /// The MRET audio recording file schema implementation.<br>
    ///
    ...
    {
        public new static readonly string NAME = nameof(AudioRecordingFileSchema);

        /// <summary>Contants used to supply parent delegates.</summary>
        public static readonly string FILE_EXTENSION = ".maudio";
        ...
        {
            { SCHEMA_VERSIONS[0], typeof(AudioRecordingVersionCheck) },
            { SCHEMA_VERSIONS[1], typeof(AudioAnnotationVersionCheck) }
        };
        public static readonly Dictionary<string, Type> SERIALIZABLE_TYPES = new Dictionary<string, Type>
        {
            { SCHEMA_VERSIONS[0], typeof(v0_1.AudioRecording) },
            { SCHEMA_VERSIONS[1], typeof(v0_9.AudioAnnotationType) }
        };
        public static readonly Type DESERIALIZABLE_TYPE = typeof(AudioPlayer); // TODO: Implement use of this
        ...
        public new static string GetDescriptionField(string filePath)
        {
            ...
            try
            {
                v0_9.AudioAnnotationType xml = (v0_9.AudioAnnotationType)FromXML(filePath);
    ...
    [System.Xml.Serialization.XmlRootAttribute("AudioRecording")]
    public class AudioRecordingVersionCheck : VersionCheck
    {
    }

    /// <seealso cref="VersionCheck"/>
    [System.Xml.Serialization.XmlRootAttribute("AudioAnnotation")]
    public class AudioAnnotationVersionCheck : VersionCheck
    {
    }
