...
namespace GOV.NASA.GSFC.XR.MRET.Schema
{
    ...
    ///
    /// <summary>
    /// SceneObjectGeneratorFileSchema
    /// 
    /// The MRET scene object generator file schema implementation.<br>
    ///
    /// Author: Jeffrey Hosler
    /// </summary>
    /// 
    public abstract class SceneObjectGeneratorFileSchema : BaseSchema
    {
        public new static readonly string NAME = nameof(SceneObjectGeneratorFileSchema);
        ...
        {
            { SCHEMA_VERSIONS[0], typeof(SceneObjectGeneratorVersionCheck) }
        };
        public static readonly Dictionary<string, Type> SERIALIZABLE_TYPES = new Dictionary<string, Type>
        {
            { SCHEMA_VERSIONS[0], typeof(v0_9.SceneObjectGeneratorType) }
        };
        ...
        public new static string GetDescriptionField(string filePath)
        {
            ...
            try
            {
                v0_9.SceneObjectGeneratorType xml = (v0_9.SceneObjectGeneratorType)FromXML(filePath);
    ...
    [System.Xml.Serialization.XmlRootAttribute("SceneObjectGenerator")]
    public class SceneObjectGeneratorVersionCheck : VersionCheck
    {
    }
