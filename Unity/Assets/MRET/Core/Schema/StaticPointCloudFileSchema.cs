...
namespace GOV.NASA.GSFC.XR.MRET.Schema
{
    ...
    ///
    /// <summary>
    /// PointCloudFileSchema
    /// 
    /// The MRET point cloud file schema implementation.<br>
    ///
    ...
    {
        public new static readonly string NAME = nameof(StaticPointCloudFileSchema);

        /// <summary>Contants used to supply parent delegates.</summary>
        public static readonly string FILE_EXTENSION = ".mpoints";
        ...
        {
            { SCHEMA_VERSIONS[0], typeof(StaticPointCloudVersionCheck) },
            { SCHEMA_VERSIONS[1], typeof(PointCloudVersionCheck) }
        };
        public static readonly Dictionary<string, Type> SERIALIZABLE_TYPES = new Dictionary<string, Type>
        {
            { SCHEMA_VERSIONS[0], typeof(v0_1.StaticPointCloudType) },
            { SCHEMA_VERSIONS[1], typeof(v0_9.PointCloudType) }
        };
        ...
        public new static string GetDescriptionField(string filePath)
        {
            ...
            try
            {
                v0_9.PointCloudType xml = (v0_9.PointCloudType)FromXML(filePath);
    ...
    [System.Xml.Serialization.XmlRootAttribute("StaticPointCloud")]
    public class StaticPointCloudVersionCheck : VersionCheck
    {
    }

    /// <seealso cref="VersionCheck"/>
    [System.Xml.Serialization.XmlRootAttribute("PointCloud")]
    public class PointCloudVersionCheck : VersionCheck
    {
    }
