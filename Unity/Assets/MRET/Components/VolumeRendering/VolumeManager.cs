...
namespace GOV.NASA.GSFC.XR.MRET.VolumeRendering
{
    /// <remarks>
    /// History:
    /// 20 September 2021: Created
    /// 11 April 2022: Converted to URP.
    /// </remarks>
	///
	/// <summary>
	/// VolumeManager
	...
	/// </summary>
	/// 
	public class VolumeManager : MRETManager<VolumeManager>
    {
		/// <seealso cref="MRETBehaviour.ClassName"/>
		public override string ClassName => nameof(VolumeManager);
        ...
        public void SetHDRISky(Texture2D tex)
        {
