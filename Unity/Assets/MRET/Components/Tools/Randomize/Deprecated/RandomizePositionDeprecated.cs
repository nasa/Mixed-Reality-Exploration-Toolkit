...
namespace GOV.NASA.GSFC.XR.MRET.Tools.Randomize
{
     ...
     */
    public class RandomizePositionDeprecated : RandomizeTransform
    {
        public new static readonly string NAME = nameof(RandomizePositionDeprecated);

        public const DistributionFunctionType DEFAULT_DISTRIBUTION_TYPE = DistributionFunctionType.Linear;
        ...
        public DistributionFunctionType distributionType = DEFAULT_DISTRIBUTION_TYPE;
        ...
        /**
         * Configures this RandomizePositionDeprecated instance from the supplied configuration settings.
         * 
        ...
        public override void Configure(RandomizeConfig config)
        {
            ...
            if (config is RandomizePositionConfigDeprecated)
            {
                RandomizePositionConfigDeprecated positionConfig = config as RandomizePositionConfigDeprecated;
    ...
    /**
    * Helper class to contain configuration settings for a RandomizePositionDeprecated class. Useful
    * for maintaining a set of configuration values for future instantiation of a RandomizePositionDeprecated
    * class, i.e. deserialization with instantiation at a later time.
    * 
    * This class is maintained here to make maintenance on RandomizePositionDeprecated easier should changes to
    * the properties need to occur.
    */
    [System.Serializable]
    public class RandomizePositionConfigDeprecated : RandomizeTransformConfig
    {
        [Tooltip("Indicates the distribution function used to position the generated object")]
        public DistributionFunctionType distributionType = RandomizePositionDeprecated.DEFAULT_DISTRIBUTION_TYPE;
        ...
        public Vector3 positionMean = new Vector3(
            RandomizePositionDeprecated.DEFAULT_POSITION_MEAN,
            RandomizePositionDeprecated.DEFAULT_POSITION_MEAN,
            RandomizePositionDeprecated.DEFAULT_POSITION_MEAN);
        ...
        public Vector3 positionStandardDeviation = new Vector3(
            RandomizePositionDeprecated.DEFAULT_POSITION_STANDARD_DEVIATION,
            RandomizePositionDeprecated.DEFAULT_POSITION_STANDARD_DEVIATION,
            RandomizePositionDeprecated.DEFAULT_POSITION_STANDARD_DEVIATION);
        ...
        public Vector3 positionMin = new Vector3(
            RandomizePositionDeprecated.DEFAULT_POSITION_MIN,
            RandomizePositionDeprecated.DEFAULT_POSITION_MIN,
            RandomizePositionDeprecated.DEFAULT_POSITION_MIN);
        ...
        public Vector3 positionMax = new Vector3(
            RandomizePositionDeprecated.DEFAULT_POSITION_MAX,
            RandomizePositionDeprecated.DEFAULT_POSITION_MAX,
            RandomizePositionDeprecated.DEFAULT_POSITION_MAX);
    }
