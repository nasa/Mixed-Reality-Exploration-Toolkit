...
namespace GOV.NASA.GSFC.XR.MRET.Tools.ProceduralObjectGeneration
{
     ...
     */
    public class ProceduralObjectGeneratorDeprecated : MonoBehaviour
    {
        public static readonly string NAME = nameof(ProceduralObjectGeneratorDeprecated);
        ...
        public ProceduralPrefabDeprecated[] prefabsLowPoly; // array of procedurally generated objects (low poly)
        [Tooltip("Array of high poly prefabs")]
        public ProceduralPrefabDeprecated[] prefabsHighPoly; // array of procedurally generated objects (high poly)
...
*/
        ...
        private GameObject GenerateObject(int index)
        {
            ...
            ProceduralPrefabDeprecated[] prefabList = null;
            ...
            ProceduralPrefabDeprecated prefab = prefabList[randomIndex];
     ...
     */
    [System.Serializable]
    public class ProceduralPrefabDeprecated
    {
         ...
         * Constructor
         */
        public ProceduralPrefabDeprecated()
        {
            NAME = nameof(ProceduralPrefabDeprecated);

            // Assign the configuration manager
            configurationManager = MRET.ConfigurationManager;
        ...
        public GameObject Instantiate(string name)
        {
            ...
            if (ColliderUtil.HasColliderInChildren(instance))
            {
