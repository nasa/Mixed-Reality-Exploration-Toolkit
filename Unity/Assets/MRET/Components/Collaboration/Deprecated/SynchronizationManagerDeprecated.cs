...
namespace GOV.NASA.GSFC.XR.MRET.Collaboration
{
    ...
    public class SynchronizationManagerDeprecated : MonoBehaviour
    {
            ...
            if (subscribed)
            {
                ...
                if (incomingMessageQueue.GetCount() > 0)
                {
                    ...
                    if (msg != null)
                    {
                        ...
                        SynchronizedObjectDeprecated synchedObj = null;
                        SynchronizedUserDeprecated synchedUser = null;
                        SynchronizedControllerDeprecated synchedController = null;
                        SynchronizedPointerDeprecated synchedPointer = null;
                        SynchronizedNoteDeprecated synchedNote = null;
                            ...
                            if (subjectFields[3] == "MSG")
                            {
                                ...
                                switch (attributeType)
                                {
                                    ...
                                    case 7:
                                        ...
                                        {
                                            synchedObj = entityBeingControlled.GetComponent<SynchronizedObjectDeprecated>();
                                            if (!synchedObj)
                                            {
                                                synchedUser = entityBeingControlled.GetComponent<SynchronizedUserDeprecated>();
                                                if (!synchedUser)
                                                {
                                                    synchedController = entityBeingControlled.GetComponent<SynchronizedControllerDeprecated>();
                                                    if (!synchedController)
                                                    {
                                                        synchedPointer = entityBeingControlled.GetComponent<SynchronizedPointerDeprecated>();
                                                        if (!synchedPointer)
                                                        {
                                                            synchedNote = entityBeingControlled.GetComponent<SynchronizedNoteDeprecated>();
                                                            if (!synchedNote)
                                                            {
                                                                return;
                                                            }
                ...
                if (outgoingEntityStatus.GetCount() > 0)
                {
                    ...
                    if (eStatus != null)
                    {
                        ...
                        if (eStatus.gameObject.GetComponent<SynchronizedUserDeprecated>())
                        {
                            pathToUse = "/LoadedProject/Users/" + eStatus.gameObject.GetComponent<SynchronizedUserDeprecated>().userAlias;
                            nameToUse = eStatus.gameObject.GetComponent<SynchronizedUserDeprecated>().userAlias.ToUpper();
                        }
                        else if (eStatus.gameObject.GetComponent<SynchronizedControllerDeprecated>())
                        {
                            pathToUse = "/LoadedProject/Users/" + eStatus.gameObject.GetComponent<SynchronizedControllerDeprecated>().synchronizedUser.userAlias
                                + "/" + ((eStatus.gameObject.GetComponent<SynchronizedControllerDeprecated>().controllerSide == SynchronizedControllerDeprecated.ControllerSide.Left)
                                ? "Left" : "Right");
                            nameToUse = eStatus.gameObject.GetComponent<SynchronizedControllerDeprecated>().synchronizedUser.userAlias.ToUpper();
                        }
                        else if (eStatus.gameObject.GetComponent<SynchronizedPointerDeprecated>())
                        {
                            pathToUse = "/LoadedProject/Users/" + eStatus.gameObject.GetComponent<SynchronizedPointerDeprecated>().synchronizedController.synchronizedUser.userAlias
                                + "/" + ((eStatus.gameObject.GetComponent<SynchronizedPointerDeprecated>().synchronizedController.controllerSide == SynchronizedControllerDeprecated.ControllerSide.Left)
                                ? "Left/Laser" : "Right/Laser");
                            nameToUse = eStatus.gameObject.GetComponent<SynchronizedPointerDeprecated>().synchronizedController.synchronizedUser.userAlias.ToUpper();
                            transformToUse = eStatus.gameObject.GetComponent<SynchronizedPointerDeprecated>().transformToUse;
                            /*if (!eStatus.gameObject.GetComponent<SynchronizedUserPointer>().pointer.IsPointerActive())
                            {
                                transformToUse.position = Vector3.zero;
                            }*/
                        }
                        else if (eStatus.gameObject.GetComponentInParent<SynchronizedControllerDeprecated>())
                        {
                            pathToUse = eStatus.gameObject.GetComponent<SynchronizedObjectDeprecated>().objectPath;
                        }
