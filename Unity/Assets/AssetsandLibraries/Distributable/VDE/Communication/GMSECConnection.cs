...
using static GOV.NASA.GSFC.XR.GMSEC.GMSECMessage.Field;
...
namespace Assets.VDE.Communication
{
    internal class GMSECConnection
    {
        ...
        private void Request()
        {
            ...
            if (rpl.kind == GOV.NASA.GSFC.XR.GMSEC.GMSECMessage.MessageKind.REPLY && rpl.subject == "GMSEC.VDE.SERVER.MSG.RESPONSE")
            {
        ...
        private void ImportRelations(GMSECMessage message)
        {
            ...
            if (count > 0)
            {
                ...
                if (rareImports.Count > 0)
                {
                    ...
                    data.links.Import(JsonUtil.Serialize(rareImports));
                }
            }
        }
        ...
        {
            GMSECMessage req = new GMSECMessage(subject, GOV.NASA.GSFC.XR.GMSEC.GMSECMessage.MessageKind.REQUEST);
