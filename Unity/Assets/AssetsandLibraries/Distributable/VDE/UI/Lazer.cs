    ...
    public class Lazer : Input.Observer
    {
        ...
        private void Awake()
        {
            if (laserBeamTransform is null)
            {
                ...
                {
#if MRET
                    GOV.NASA.GSFC.XR.MRET.Components.UIInteraction.UIPointerController uip = gameObject.GetComponentInChildren<GOV.NASA.GSFC.XR.MRET.Components.UIInteraction.UIPointerController>();
                    if (!(uip is null))
                    {
