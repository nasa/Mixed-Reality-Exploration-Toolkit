...
namespace Assets.VDE.UI
{
    ...
    internal class Link : GOV.NASA.GSFC.XR.MRET.SceneObjects.InteractableSceneObject
#else
...
#endif
    {
        ...
        protected override void MRETStart()
        {
            ...
            GrabBehavior = GOV.NASA.GSFC.XR.MRET.SceneObjects.IInteractable.GrabBehaviors.Custom;
            TouchBehavior = GOV.NASA.GSFC.XR.MRET.SceneObjects.IInteractable.TouchBehaviors.Custom;
            Grabbable = false;
            Usable = true;
        }
#endif
...
#if MRET_2021_OR_LATER
        protected override void AfterBeginTouch(GOV.NASA.GSFC.XR.CrossPlatformInputSystem.InputHand hand)
        {
            base.AfterBeginTouch(hand);

            SetFocus(true);
        }
        protected override void AfterEndTouch(GOV.NASA.GSFC.XR.CrossPlatformInputSystem.InputHand hand)
        {
