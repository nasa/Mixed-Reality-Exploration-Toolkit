...
namespace GSFC.ARVR.MRET.Components.LineDrawing
{
	...
	public class LineDrawingController : MRETUpdateBehaviour
	{
        ...
        /// Type of drawing.
        /// </summary>
        public LineDrawingManager.DrawingType drawingType;
...
#region Creation
        ...
        /// </summary>
        private LineDrawing currentLine = null;
        ...
        private void BeginNewLine(Vector3? point = null)
        {
            ...
            currentLine = Infrastructure.Framework.MRET.SceneObjectManager.CreateLineDrawing(
        ...
        {
            DestroyPreview();
            Infrastructure.Framework.MRET.UndoManager.AddAction(ProjectAction.AddDrawingAction(currentLine),
                ProjectAction.DeleteDrawingAction(currentLine.name, currentLine.uuid.ToString()));
            currentLine = null;
        }
...
#region Edition
        ...
        public void AddToLine(LineDrawing lineToAddTo, bool drawAtBeginning = false)
        {
            if (currentLine != null)
            {
