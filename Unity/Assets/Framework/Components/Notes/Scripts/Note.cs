...
{
    public class Note : SceneObject, ISelectable
    {
        ...
        public void StopDrawing(GameObject controller)
        {
            ...
            if (hand)
            {
                if (hand == Infrastructure.Framework.MRET.InputRig.rightHand && currentRightLine)
                {   // Right.
        ...
        public void StartDrawing(GameObject controller)
        {
            ...
            if (hand)
            {
                if (hand == Infrastructure.Framework.MRET.InputRig.rightHand)
                {   // Right.
