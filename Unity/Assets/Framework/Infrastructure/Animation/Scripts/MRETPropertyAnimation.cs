...
{
    public class MRETPropertyAnimation : MRETBaseAnimation
    {
        ...
        /// </summary>
        public MRETPropertyAnimation() : base()
        {
        ...
        public static void DeserializeTo(AnimationPropertyType serializedAnimation, MRETPropertyAnimation animation)
        {
        ...
        public static MRETBaseAnimation Deserialize(AnimationPropertyType serializedAnimation)
        {
