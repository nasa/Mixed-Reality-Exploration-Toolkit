...
namespace GSFC.ARVR.MRET.Infrastructure.Framework.Animation
{
    ...
    /// </summary>
    public abstract class MRETBaseAnimation
    {
        // Fields
        ...
        public static void DeserializeTo(AnimationBaseType serializedAnimation, MRETBaseAnimation animation)
        {
