...
namespace Octree
{
    public class OctreeHandler : MonoBehaviour
    {
        ...
        float distance;
        OctreeNode<Vector3> currentNode;
        OctreeNode<Vector3> rootNode;
        ...
        void Start()
        {
            ...
            // debugging
            octree = new Octree<Vector3>((PointCloudScript.GetPointCloudBounds().size.x / 100f), PointCloudScript.GetPointCloudBounds().center, 1f);
            // octree = new Octree<Vector3>(PointCloudSizeMeters, PointCloudScript.GetPointCloudPosition(), 1);
        ...
        public Octree<Vector3> GetOctree()
        {
            return octree;
        }

        void AddAndDestroyPointColliders(OctreeNode<Vector3> currentNode)
        {
            ...
            {
                foreach (OctreeNode<Vector3> point in currentNode.children)
                {
