...
using GSFC.ARVR.MRET.Components.FeedPanels;
...
#region Hookups
        ...
        public void Initialize()
        {
            ...
            teleportToggleEnableEvent.AddListener(() => { SetToggle(teleportToggle, (bool) DataManager.instance.FindPoint(LocomotionManager.teleportKey)); });
            ...
            flyToggleEnableEvent.AddListener(() => { SetToggle(flyToggle, (bool) DataManager.instance.FindPoint(LocomotionManager.flyKey)); });
            ...
            if (cams.Item2.Length == 3)
            {
                ...
                cam0ToggleEnableEvent.AddListener(() => { SetToggle(cams.Item2[0],
                    (bool) DataManager.instance.FindPoint(CameraMenuController.imageCamera0Key) ||
                    (bool) DataManager.instance.FindPoint(CameraMenuController.imageCamera1Key)); });
                cam1ToggleEnableEvent.AddListener(() => { SetToggle(cams.Item2[1],
                    (bool) DataManager.instance.FindPoint(CameraMenuController.videoCamera0Key) ||
                    (bool) DataManager.instance.FindPoint(CameraMenuController.videoCamera1Key));
                });
            ...
            bodyCameraToggleEnableEvent.AddListener(() => { SetToggle(bodyCameraToggle, (bool) DataManager.instance.FindPoint(CameraMenuController.bodyCameraKey)); });
            ...
            if (ruls.Item2.Length == 3)
            {
                ...
                rul0ToggleEnableEvent.AddListener(() => { SetToggle(ruls.Item2[0],
                    (bool) DataManager.instance.FindPoint(RulerMenuController.siRulerKey));
                });
                rul1ToggleEnableEvent.AddListener(() => { SetToggle(ruls.Item2[1],
                    (bool) DataManager.instance.FindPoint(RulerMenuController.imperialUnitsKey));
                });
            ...
            leftPanelToggleEnableEvent.AddListener(() => {
                SetToggle(leftPanelToggle, (bool) DataManager.instance.FindPoint(thisHand.handedness == InputHand.Handedness.right ?
                    FeedSourceMenuController.leftScreen1Key : FeedSourceMenuController.leftScreen0Key)); });
            rightPanelToggleEnableEvent.AddListener(() => {
                SetToggle(rightPanelToggle, (bool) DataManager.instance.FindPoint(thisHand.handedness == InputHand.Handedness.right ?
            ...
            noteToggleEnableEvent.AddListener(() => {
                SetToggle(noteToggle, (bool) DataManager.instance.FindPoint(NoteManager.notesKey));
            });
            ...
            selectionToggleEnableEvent.AddListener(() => {
                SetToggle(noteToggle, (bool) DataManager.instance.FindPoint(ControllerSelectionManager.selectionKey));
            });
        ...
        public void MenuShown()
        {
            ...
            foreach (InputHand hand in inputRig.hands)
            {
                if (hand != thisHand)
                {
                    hand.ToggleUIPointerOn(true, true);
                    hand.BlockTeleport();
