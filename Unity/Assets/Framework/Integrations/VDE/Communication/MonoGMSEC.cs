...
{
    public class MonoGMSEC : GSFC.ARVR.GMSEC.MonoGMSEC
    {
        ...
        public new void Initialize()
        {
            ...
            gmsecPath = GSFC.ARVR.PackageLoader.GetPackagePath(UnityEngine.Application.dataPath, "UnityGMSEC");

            // Initialize the GMSEC DLL
            GSFC.ARVR.PackageLoader.InitializePackagePlugin(gmsecPath);
        }
    }
}
#endif