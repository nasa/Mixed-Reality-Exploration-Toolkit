...
namespace Assets.VDE.UI.Node
{
    ...
    internal class Container : Assets.VDE.UI.Container, GSFC.ARVR.MRET.Selection.ISelectable
#else
...
#endif
    {
        ...
        public override void BeginGrab(GSFC.ARVR.MRET.Infrastructure.CrossPlatformInputSystem.InputHand hand)
        {
        ...
        public override void EndGrab(GSFC.ARVR.MRET.Infrastructure.CrossPlatformInputSystem.InputHand hand)
        {
