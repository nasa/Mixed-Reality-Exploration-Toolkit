...
// Using the "ImportUrdf" namespace
// Added the ImportOneMesh function to return the head of the meshes List imported
...
namespace RosSharp.ImportUrdf
{
    public static class StlImporter
    {
        ...
        public static Mesh ImportOneMesh(string path)
        {
            return ImportMesh(path)[0];
        }
